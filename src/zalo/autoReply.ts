...
export async function maybeAutoReply(
  ...
  sentMsgStore.markSending(accountId, threadId);
  try {
    ...
    if (zMsgId !== undefined) {
      sentMsgStore.save(_syntheticTgSeq--, { accountId, msgIds: [String(zMsgId)], zaloId: threadId, threadType: 0 });
    }
    ...
    sentMsgStore.unmarkSending(accountId, threadId);
  }
}
