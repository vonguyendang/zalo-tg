...
| `/history [N]` | Nạp tối đa 50 tin nhắn cũ của nhóm qua luồng WebSocket |
| `/restart` | Khởi động lại bridge sau bước xác nhận (chỉ admin; cần `run.sh`, systemd, Docker hoặc `tsx watch`) |
