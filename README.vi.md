...
Xem hướng dẫn chi tiết tại [`HDSD file command.md`](docs/vi/quick-start-command.md).
...
Xem hướng dẫn từng bước tại [`HDSD file automation.md`](docs/vi/quick-start-automation.md).
...
1. **Xây dựng hoặc tải xuống máy chủ** (xem [Hướng dẫn thiết lập Local Bot API](docs/vi/local-bot-api-setup.md))
...
Để cài đặt chi tiết trên **macOS, Linux, Windows**, xem [**Hướng dẫn thiết lập Local Bot API**](docs/vi/local-bot-api-setup.md):
